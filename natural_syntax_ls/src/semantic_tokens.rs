...
pub const fn token_type_n_modifiers(pos: PartOfSpeech) -> (u32, u32) {
    ...
    match pos {
        ...
        PartOfSpeech::JJS => {
            ...
            (
                TokenType::TYPE as u32,
                modifiers_to_bitmap(&[TokenModifier::DEFAULT_LIBRARY]),
            )
        }
        PartOfSpeech::MD => {
            ...
            (
                TokenType::KEYWORD as u32,
                modifiers_to_bitmap(&[TokenModifier::READONLY]),
            )
        }
        PartOfSpeech::NN => {
        ...
        PartOfSpeech::NNP => {
            ...
            (
                TokenType::TYPE as u32,
                modifiers_to_bitmap(&[TokenModifier::DECLARATION]),
            )
        }
        PartOfSpeech::NNPS => {
            ...
            (
                TokenType::TYPE as u32,
                modifiers_to_bitmap(&[TokenModifier::DEFINITION]),
            )
        }
        PartOfSpeech::NNS => {
        ...
        PartOfSpeech::PRP => {
            ...
            (TokenType::TYPE_PARAMETER as u32, 0)
        }
        PartOfSpeech::RB => {
